window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    module.exports.apply = function apply(ctx) {
      ...
      // Register exclusively in settings.plugin.item (DSH Settings → Plugins tab).
      // Custom top-level sidebar sections (settings.section) are forbidden for simple plugin settings cards.
      try {
